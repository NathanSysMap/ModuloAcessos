/*
  # Fix RPC function to use pgcrypto extension correctly
  
  ## Summary
  Updates the create_user_with_profile function to reference pgcrypto functions correctly
  
  ## Changes
  - Updates search_path to include extensions schema where pgcrypto is installed
  - Ensures crypt() and gen_salt() functions are accessible
*/
